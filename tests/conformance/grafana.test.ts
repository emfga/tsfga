...
describe("Grafana Model Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    await tsfgaClient.writeRelationConfig({
      ...
      directlyAssignable: [
        { type: "user", condition: "subresource_filter" },
        { type: "service-account", condition: "subresource_filter" },
        { type: "team", relation: "member", condition: "subresource_filter" },
        { type: "role", relation: "assignee", condition: "subresource_filter" },
      ],
    ...
    await tsfgaClient.writeRelationConfig({
      objectType: "team",
      relation: "admin",
      directlyAssignable: [{ type: "user" }, { type: "service-account" }],
      impliedBy: null,
      computedUserset: null,
      tupleToUserset: null,
      excludedBy: null,
    ...
    await tsfgaClient.writeRelationConfig({
      ...
      relation: "admin",
      directlyAssignable: [
        { type: "user", condition: "group_filter" },
        { type: "service-account", condition: "group_filter" },
        { type: "team", relation: "member", condition: "group_filter" },
        { type: "role", relation: "assignee", condition: "group_filter" },
      ],
      impliedBy: null,
      computedUserset: null,
      tupleToUserset: null,
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./grafana/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
